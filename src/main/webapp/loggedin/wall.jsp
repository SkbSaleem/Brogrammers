					...
					<form action="/UNSWBook/WallServlet" method="post">
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								...
								&nbsp; wrote: <br> <input class="form-inline" type="text"
									value="<c:out value="${array.content}" />" disabled
									style="cursor: default"> <input type="hidden"
									name="post_id" value="<c:out value="${array.postid}" />">
								<button name="likes" type="submit" class="btn btn-primary"
									value="<c:out value="${array.likes}" />">Like!</button>
								<span style="float: right" class="glyphicon glyphicon-thumbs-up">
									<c:out value="${array.likes}" />
								</span>
							</div>
						</div>
					</form>
